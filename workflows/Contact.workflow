...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <ccEmails>volunteer@daring-adventures.org</ccEmails>
    ...
    <fieldUpdates>
        <fullName>Household_Size_Annual_Income</fullName>
        <field>Below_Amount_Listed__c</field>
        <literalValue>1</literalValue>
        <name>Household Size/ Annual Income</name>
